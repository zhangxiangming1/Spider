...
2：点击“属性”
3：点击“配置属性->配置”
4：整个解决方案的“配置”框选择“Debug”或"Release"，“平台”框选择"x64"
5: Greatzee.Spider.Winform项目的平台必须选择"x64"，其他项目无要求
6：选择多项目启动，启动顺序为：SiteDemo->SocketStorage->Greatzee.Spider.Winform
注意：解决方案的平台和Greatzee.Spider.Winform项目的平台可以选择x64或x86，但不能是anycpu，两个平台必须一致
--------------------------------------------------------------------
配置文件位置：
